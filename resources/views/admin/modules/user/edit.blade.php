                        ...
                        <div class="row mb-4">
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="email" class="form-control" id="email" aria-describedby="emailHelp" name="email" value="{{old('email',$user->email)}}" readonly >
                                </div>
                                <!-- End of Form -->    
                                <!-- Form -->
                                <div class="mb-3">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        <input type="password" class="form-control" id="exampleInputIconPassword" placeholder="Password" aria-label="Password" name="password">
                            ...
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" id="country" aria-label="Default select example" name="level" {{$myself ? 'selected' : ''}} disabled>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" id="country" aria-label="Default select example" name="status">
                                        ...
                                        <option value="2" {{old('status',$user->status) == 2 ? 'selected' : '' }}>Hidde</option>
                                    </select>
                                </div>
                            </div>
