...
<div class="sidebar-inner px-2 pt-3">
    ...
    <li class="nav-item">
        <a href="{{route('admin.dash.index')}}" class="nav-link d-flex align-items-center">
    ...
    <li class="nav-item ">
        <a href="{{route('admin.dash.index')}}" class="nav-link">
        ...
        data-bs-target="#submenu-laravel" aria-expanded="true">
            ...
            <span>
                <span class="sidebar-icon">
                    <i class="fab fa-laravel me-2" style="color: #fb503b;"></i>
                </span>
                <span class="sidebar-text" style="color: #fb503b;">CATEGORY</span>
            </span>
        ...
        <div class="multi-level collapse show" role="list" id="submenu-laravel" aria-expanded="false">
            ...
            <ul class="flex-column nav">
                ...
                <a href="{{route('admin.category.create')}}" class="nav-link">
                    <span class="sidebar-text">Create Category</span>
                </a>
                </li>
            </ul>
        </div>
    ...
    <li class="nav-item">
        ...
        data-bs-target="#submenu-laravel" aria-expanded="true">
            <span>
                ...
                <span class="sidebar-text" style="color: #fb503b;">PRODUCT</span>
            </span>
            <span class="link-arrow"><svg class="icon icon-sm" fill="currentColor" viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd"
            ...
            <ul class="flex-column nav">
                <li class="nav-item ">
                    <a href="{{route('admin.product.index')}}" class="nav-link">
                        <span class="sidebar-text">List Product</span>
                    </a>
                </li>
                <li class="nav-item ">
                    <a href="{{route('admin.product.create')}}" class="nav-link">
                        <span class="sidebar-text">Create Product</span>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <li class="nav-item">
        ...
        <span>
            <span class="sidebar-icon">
                <i class="nav-icon fas fa-users" style="color: #fb503b;"></i>
                </span>
            <span class="sidebar-text" style="color: #fb503b;">USER</span>
        </span>
        <span class="link-arrow"><svg class="icon icon-sm" fill="currentColor" viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd"
    ...
    <li class="nav-item">
        ...
        <ul class="flex-column nav">
            <li class="nav-item">
            <a class="nav-link" href="https://volt-laravel-admin-dashboard.updivision.com/profile-example">
                <span class="sidebar-text">Profile</span>
            </a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="https://volt-laravel-admin-dashboard.updivision.com/login-example">
                <span class="sidebar-text">Sign In</span>
            </a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="https://volt-laravel-admin-dashboard.updivision.com/register-example">
                <span class="sidebar-text">Sign Up</span>
            </a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="https://volt-laravel-admin-dashboard.updivision.com/forgot-password-example">
