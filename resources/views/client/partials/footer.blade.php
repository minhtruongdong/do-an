...
{{-- <script src="{{asset('administrator/js/jquery-ui.1.12.1.js')}}"></script> --}}
@stack('js')
<script src="http://maps.googleapis.com/maps/api/js?sensor=false&amp;language=en"></script>
<script src="{{asset('administrator/js/map.js') }}"></script>
<script src="{{asset('administrator/js/global.js') }}"></script>