...
<div id="content">
    ...
    <div class="baner-bg">
        <div class="bg-item fix" style="background-image:url(img/about_bg.jpg)"></div>
           <div class="vertical-align full white-color">
                <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0">
                    <h2 class="h2 title">about us<span></span></h2>
    ...
    <section class="section">  
        ...
        <div class="container">
            ...
            <div class="empty-space h30-xs h30-sm"></div>
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                   <p>Aliquam vulputate turpis quis nibh tempus finibus. In fringilla nulla quis lacus sagittis, sed malesuada enim faucibus. Nulla interdum dolor mauris, vitae molestie dui bibendum et. Praesent non felis in sem placerat mattis eget et justo. Fusce quis justo et arcu tristique gravida sit amet</p> 
                </div>
                <div class="col-sm-6 col-xs-12">
                   <p>Donec purus lacus, vehicula vitae posuere quis, dignissim ut lectus. Fusce et purus malesuada, vulputate nisi id, convallis purus. Nam porta ipsum at consequat molestie. In nunc nisl, gravida sed tortor id, consequat mollis quam. Quisque accumsan aucto nisi id, convallis purus</p> 
                </div>
            </div>
            <div class="empty-space h35-xs"></div>
            <div class="row">
                <div class="col-xs-12">
                    <div class="center-wrap"><a href="#" class="btn-2"><span>contact us</span></a></div>
                </div>
            </div>
        </div>
    </section> 
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="row nopadding">
                                    <div class="col-md-6 col-md-push-5">
                                        <div class="img-wrapper">
                                            <img src="img/swiper-img-1.jpg" alt="">
                                        </div>
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="row nopadding">
                                    <div class="col-md-6 col-md-push-5">
                                        <div class="img-wrapper">
                                            <img src="img/swiper-img-1-2.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="col-sm-10 col-sm-offset-1 col-md-4 col-md-offset-1 col-md-pull-6">
                                        <article>
                            ...
                            <div class="swiper-slide">
                                <div class="row nopadding">
                                    <div class="col-md-6 col-md-push-5">
                                        <div class="img-wrapper">
                                            <img src="img/swiper-img-1-3.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="col-sm-10 col-sm-offset-1 col-md-4 col-md-offset-1 col-md-pull-6">
                                        <article>
            ...
            <div class="col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1">
                ...
                <div class="swiper-style-3">
                    ...
                    <div class="swiper-container" data-speed="1000" data-space="140" data-pagination-rel="3" data-breakpoints="1" data-slides-per-view="2" data-xs-slides="1" data-sm-slides="2" data-md-slides="2">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="img/author-img-1.png" alt="">
                                <div class="empty-space h30-xs"></div>
                            ...
                            <div class="swiper-slide">
                                <img src="img/author-img-2.png" alt="">
                                <div class="empty-space h30-xs"></div>
                                <img src="img/quote.png" alt="">
                                <div class="empty-space h25-xs"></div>
                                <article>
                    ...
                    <div class="col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1">
                        ...
                        <div class="swiper-container" data-speed="1000" data-space="30" data-pagination-rel="2" data-breakpoints="1" data-slides-per-view="3" data-xs-slides="1" data-sm-slides="2" data-md-slides="3">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="img-wrapper">
                                        <img src="img/swiper-img-2.jpg" alt="">
                                    </div>
                                    <div class="empty-space h25-xs"></div>
                                    <article class="bg-text">
                                ...
                                <div class="swiper-slide">
                                    <div class="img-wrapper">
                                        <img src="img/swiper-img-3.jpg" alt="">
                                    </div>
                                    <div class="empty-space h25-xs"></div>
                                    <article class="bg-text">
                                ...
                                <div class="swiper-slide">
                                    <div class="img-wrapper">
                                        <img src="img/swiper-img-4.jpg" alt="">
                                    </div>
                                    <div class="empty-space h25-xs"></div>
                                    <article class="bg-text">
